...
describe('float + float ', () => {
  ...
  it('0.000123456780000 + 0.1234560000 = 0.12357945678', () => {
    expect(new Calculator('0.000123456780000').plus('0.1234560000').result()).toBe('0.123579456780000')
  })
  
  it('0.000000000000001234 + 0.000000000056543456 = 0.00000000005654469', () => {
    expect(new Calculator('0.000000000000001234').plus('0.000000000056543456').result()).toBe('0.000000000056544690')
  })
})
