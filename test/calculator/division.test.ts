...
describe('float / float ', () => {
  ...
  it('0.000123456780000 / 0.1234560000 = 0.0010000063180404354587869362363', () => {
    expect(new Calculator('0.000123456780000').division('0.1234560000').result()).toBe('0.0010000063180404354587869362363')
  })
